...
public class OutreachCoordination extends AbstractPanelRounded {
    ...
    private TextSubtitle TableTextCredentials;
    private TextSubtitle TableTextResult;
    private TextSubtitle TableTextProposal;
    private TextSubtitle TableTextObservation;

    private int fontsizeTableTextHeader = 20;

    public OutreachCoordination() {
        super(0);
        initOutreachCoordination();
    }

    private void initOutreachCoordination() {
    ...
    private void createTable() {
        ...
        TableTextProposal = new TextSubtitle("Propuesta", SwingConstants.CENTER);
        TableTextCredentials = new TextSubtitle("Credenciales", SwingConstants.CENTER);
        ...
        TableTextCredentials.setFontSize(fontsizeTableTextHeader);
        TableTextResult.setFontSize(fontsizeTableTextHeader);
        TableTextProposal.setFontSize(fontsizeTableTextHeader);
        ...
        containerCenterHeader.add(TableTextProposal);
        containerCenterHeader.add(TableTextCredentials);
